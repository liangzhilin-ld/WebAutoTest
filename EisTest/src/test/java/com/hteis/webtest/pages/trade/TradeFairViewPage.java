...
public class TradeFairViewPage extends PageBase {
	...
	public HtmlInput getTradeAmountInput(){
		return this.findElementByName("tnTradeSize").toHtmlInput();
	}
	...
	public HtmlInput getSupplyCountInput(){
		return this.findElementById("tnSuppQua").toHtmlInput();
	}
	
	/***需求方数量*/
	public HtmlInput getBuyerCountInput(){
		return this.findElementById("tnRequQua").toHtmlInput();
	}
